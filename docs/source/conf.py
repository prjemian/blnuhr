# -*- coding: utf-8 -*-
#
# blnuhr documentation build configuration file, created by
...
project = blnuhr.__package_name__
copyright = blnuhr.__copyright__
...
versioneer_version = blnuhr.__version__.split('+')
...
htmlhelp_basename = blnuhr.__package_name__ + 'doc'
